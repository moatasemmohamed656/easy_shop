...
return success(_that.imageUrl);case Error() when error != null:
...
return success(_that.imageUrl);case Error():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
class Loading implements UploadImageState {
  const Loading();
...
class Success implements UploadImageState {
  const Success(this.imageUrl);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Success&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl));
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $UploadImageStateCopyWith<$Res> {
...
class Error implements UploadImageState {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $UploadImageStateCopyWith<$Res> {
